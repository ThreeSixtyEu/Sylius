                    ...
                    ->children()
                        ->arrayNode('payment_method')
                            ...
                            ->children()
                                ...
                                ->arrayNode('translatable')
                                    ->addDefaultsIfNotSet()
                                    ->children()
                                        ->scalarNode('targetEntity')->defaultValue('Sylius\Component\Payment\Model\PaymentMethodTranslation')->end()
			            ...
			            ->arrayNode('payment_method_translation')
				            ...
				            ->children()
					            ...
					            ->scalarNode('controller')->defaultValue('Sylius\Bundle\ResourceBundle\Controller\ResourceController')->end()
					            ->scalarNode('repository')->end()
					            ->scalarNode('form')->defaultValue('Sylius\Bundle\PaymentBundle\Form\Type\PaymentMethodTranslationType')->end()
				            ->end()
			            ->end()
                        ->arrayNode('payment')
                            ->addDefaultsIfNotSet()
